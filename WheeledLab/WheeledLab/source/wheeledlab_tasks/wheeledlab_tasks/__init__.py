...
# import wheeledlab_tasks.driving.config.agent.uwc as uwc_drive_agents
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": "wheeledlab_tasks.driving.config.agent.uwc.rsl_rl_ppo_cfg:UWCDrivePPORunnerCfg",
